...
class JwtAccessTokenTest {
    ...
    fun testDecodeValidJwtAndParsePayload() {
        ...
        Assert.assertEquals(1730386695, jwtPayload.expirationTime as Int)
        Assert.assertEquals("https://mobilesdkatsdb6.test1.my.pc-rnd.salesforce.com", jwtPayload.issuer)
        Assert.assertEquals(1730386620, jwtPayload.notBeforeTime as Int)
    ...
    companion object {
        ...
        private val TEST_RAW_JWT = listOf(HEADER, PAYLOAD, SIGNATURE)
